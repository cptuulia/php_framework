...
--
-- Host: php_framework_mysql    Database: php_framework_db_name
-- ------------------------------------------------------
...
CREATE TABLE `admin_users` (
  ...
  `api_token_expires` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `familyName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `email_login_hash` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_login_hash_expires` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-03-19 10:36:40
